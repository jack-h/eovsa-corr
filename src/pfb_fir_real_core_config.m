...
function pfb_fir_real_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fir_real_core');
  ...
  pol1_out2_port.setType('Fix_18_17');
  pol1_out3_port = this_block.port('pol1_out3');
  pol1_out3_port.setType('Fix_18_17');
  pol1_out4_port = this_block.port('pol1_out4');
  pol1_out4_port.setType('Fix_18_17');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfb_fir_real_core.vhd');
