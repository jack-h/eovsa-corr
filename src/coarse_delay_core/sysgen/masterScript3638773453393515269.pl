...
$ENV{'SYSGEN'} = '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/home/observer/projects/eovsa-corr/src/coarse_delay_core/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/home/observer/projects/eovsa-corr/src/coarse_delay_core/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 0.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 78021.00036621094,
    'generating_subsystem_handle' => 78021.00036621094,
    ...
    'isdeployed' => 0,
    'ise_version' => '14.5i',
    'master_sysgen_token_handle' => 78027.32678222656,
    'matlab' => '/home/observer/tools/MATLAB/R2012b',
    'matlab_fixedpoint' => 0.0,
    'mdlHandle' => 78021.00036621094,
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 78021.00036621094,
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '8ee05eacc518ce1238fd1cc5d24c0c47',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '02bd83a2aa6703dc7d90cc063bef0267',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  $instrs = {
    'entity_declaration_hash' => '5e2697befa48c169b46fdbe716332f6c',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '757998fcc9a8ee4cd009ff0215a7ce9c',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cf1a5bd98d221429fd0c7f87f0f04f01',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
',
    ...
    'CSET component_name = bmg_72_a2850c3cf4c038cd',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '8e7ac7003f786dbc6debdab31990d08d',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xldpram_coarse_delay_core',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '17ca505de6cafb42c1471f5d74415b63',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'counter_6cd08a247e',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'df4fc91f1bb96b26f3ec15bd8aabef11',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal a_17_32: unsigned((12 - 1) downto 0);
...
begin
  ...
  $instrs = [
    ...
    'CSET component_name = addsb_11_0_07ee7685fe6aac24',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'fa4a07b20d8bab146cc7143f8775c939',
    ...
    b: in std_logic_vector(13 - 1 downto 0)',
      ...
      'entityName' => 'xladdsub_coarse_delay_core',
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '7100a292ce65c5f5e71a74682aab90b7',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '66318a54418e17f9fc3d3bfddf56dde7',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'ec861c69e786a1c954129ea08df0086e',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'de96d935053da9c740335c67b1cd21ad',
    'sourceFile' => '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/home/observer/tools/Xilinx/14.5/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /home/observer/projects/eovsa-corr/src/coarse_delay_core/sysgen/script_results6295889350063104533') || 
    croak 'couldn\'t open /home/observer/projects/eovsa-corr/src/coarse_delay_core/sysgen/script_results6295889350063104533';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /home/observer/projects/eovsa-corr/src/coarse_delay_core/sysgen/script_results6295889350063104533';
};
